...
def plot_epipolar_lines(image1, image2, uncalibrated_1, uncalibrated_2, E, K, plot=True):
    ...
    """ YOUR CODE HERE
    """
    epipolar_lines_in_1 = uncalibrated_2.T@((np.linalg.inv(K).T)@E@np.linalg.inv(K))
    epipolar_lines_in_2 = uncalibrated_1.T@np.linalg.inv(K.T)@E.T@np.linalg.inv(K)#@uncalibrated_2

    epipolar_lines_in_1 = epipolar_lines_in_1.T
    epipolar_lines_in_2 = epipolar_lines_in_2.T
